exemple: exemple.o libisentlib.a LbpLib.o
	gcc -Wall exemple.o -o exemple libisentlib.a LbpLib.o -lm -lglut -lGL -lX11
...
LbpLib.o : LbpLib.c LbpLib.h BmpLib.h
	gcc -Wall -O2 -c LbpLib.c
